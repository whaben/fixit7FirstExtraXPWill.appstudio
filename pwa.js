...
const cacheName = 'fixit7FirstExtraXPWill-2020-10-03 18:59:52.938982'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit7FirstExtraXPWill'.length) === 'fixit7FirstExtraXPWill') {
